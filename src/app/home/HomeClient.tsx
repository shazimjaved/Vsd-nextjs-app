      ...
      <div className="space-y-20 md:space-y-28">
        ...
        <section>
            <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground mt-2 max-w-2xl mx-auto">Join the VSD ecosystem with a few simple steps. For a complete guide, read our <Link href="/faq" className="text-primary hover:underline">knowledge base</Link>.</p>
            </div>
