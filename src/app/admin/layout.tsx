  ...
  return (
    <>
      ...
      <div className="grid min-h-screen w-full md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr] relative z-10">
        <div className="hidden border-r bg-black/50 backdrop-blur-md md:block">
        ...
        <div className="flex flex-col">
          <header className="flex h-14 items-center gap-4 border-b bg-black/50 backdrop-blur-md px-4 lg:h-[60px] lg:px-6">
              <Sheet>
